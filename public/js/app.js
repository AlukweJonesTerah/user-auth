App = {
  ...
  loadContracts: async () => {
    ...
    console.log("Usrer ABI: ", UserContract.abi);

    // emission contract ABI
    const emissionContract = await $.getJSON("/contracts/Emission.json");
    const emissionContractAddress = "0xDc64a140Aa3E981100a9becA4E685f962f0cF6C9";
    ...
    // KYC ABI
    const KYCContract = await $.getJSON("/contracts/KYCProcess.json");
    const KYCContractAddress = "0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0";
